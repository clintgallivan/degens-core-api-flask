...
#! DEPRECATED: This function is no longer used. It has been replaced by the `update_tokens_timeseries` function in the `jupiter_timeseries_cron` module. This was due to a switch over from mongodb timeseries collection to tinybird
